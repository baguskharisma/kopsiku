  ...
  async printReceipt(data: {
    ...
    try {
      ...
      this.printer.tableCustom([
        ...
        {
          text: `Rp ${data.baseFare.toLocaleString()}`,
          align: 'RIGHT',
          width: 0.5,
        },
      ]);
      this.printer.tableCustom([
        ...
        {
          text: `Rp ${data.additionalFare.toLocaleString()}`,
          align: 'RIGHT',
          width: 0.5,
        },
      ]);
      this.printer.tableCustom([
        ...
        {
          text: `Rp ${data.airportFare.toLocaleString()}`,
          align: 'RIGHT',
          width: 0.5,
        },
      ]);
      ...
      this.printer.tableCustom([
        ...
        {
          text: `Rp ${data.totalFare.toLocaleString()}`,
          align: 'RIGHT',
          width: 0.5,
        },
      ]);
